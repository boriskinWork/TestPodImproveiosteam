...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TestPodImroveiosteam123.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Alexei Pozdnyakov/TestPodImroveiosteam123'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Alexei Pozdnyakov' => 'pozdnyakov.alexei@gmail.com' }
  s.source           = { :git => 'https://github.com/Alexei Pozdnyakov/TestPodImroveiosteam123.git', :tag => s.version.to_s }
